...
muss nur noch der vom Projekt in .pre-commit-config.yaml definierte Hook installiert werden. Dies geschieht durch pre-commit install. Nun muss man sich
keine Gedanken mehr über Black machen. Bei jedem Commit wird der Black Formatter über den Code geschickt.
